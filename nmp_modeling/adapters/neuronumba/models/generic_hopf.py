...
#   sigma/sigmas: stochastic noise amplitude, s^-1/2
#
...
#
# The stochastic term is generated by the adapter/integrator, not by dfun.
# When this model is used through NeuronumbaAdapter, sigma/sigmas are
# interpreted in Hopf literature units, s^-1/2, and converted to ms^-1/2
# by the adapter before integration.
# ==========================================================================
import numpy as np
import numba as nb
...
class GenericHopf(Model):
    ...
    def get_jacobian(self, weights=None, unit="s"):
        """Return the linearized Hopf Jacobian around z = 0.

        By default, the Jacobian is returned in second-based literature units.
        Use unit="ms" to match the millisecond-based Neuronumba integrator.
        """
